...
async function poblarDB() {
    ...
    try {
        ...
        operacion = await AltaDB(Operacion, "./aplicaciones/BaseDeDatosJSON/operaciones.json", Proceso, "proceso", "nombre")
...
async function AltaDB(col1, ruta, col2, col1Clave, col2Clave){
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            fichero = JSON.parse(await fs.readFileSync(ruta, 'latin1'));
            console.log("Mi fichero lee los acentos: " + JSON.stringify(fichero))
